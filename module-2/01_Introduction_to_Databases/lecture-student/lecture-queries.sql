...
SELECT 'Hello World' || 'Hello!' AS derivedGreeting;
...
-- how would you add the population density as 'density'?
SELECT city_name, area, population, population/area AS density FROM city WHERE area < 25 AND population > 100000
...
SELECT city_name, area, population FROM city WHERE state_abbreviation IN ('CA', 'FL');
...
SELECT * FROM city WHERE city_name LIKE '%Falls';
