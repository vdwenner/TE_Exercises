...
public class EmployeeProjectsCLI {
	...
	private static final String PROJ_MENU_OPTION_ALL_PROJECTS = "Show all projects";
	...
	private static final String[] PROJ_MENU_OPTIONS = new String[] { PROJ_MENU_OPTION_ALL_PROJECTS,
	...
	private void handleProjects() {
		...
		if(choice.equals(PROJ_MENU_OPTION_ALL_PROJECTS)) {
	...
	private void handleListAllProjects() {
