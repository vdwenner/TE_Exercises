...
public class Werewolf extends HalloweenMonster{

    public Werewolf(){
        super();
    }

    public Werewolf(String humanName, String monsterName, int age, int scariness, String scaryPhrase, String trick){
