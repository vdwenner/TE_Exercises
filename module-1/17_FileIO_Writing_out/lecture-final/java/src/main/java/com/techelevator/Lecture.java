...
public class Lecture {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println();
		System.out.println("File content is being overwritten with your message");
		...
		System.out.println();
		System.out.println("Your message is now being appended to the file content");


		try(PrintWriter writer = new PrintWriter(new FileOutputStream(newFile,true))){
				writer.println("This line was APPENDED using a FileOutputStream with message: '" + message + "' ");
		}
